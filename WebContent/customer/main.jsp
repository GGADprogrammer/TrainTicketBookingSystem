								...
								<div id="nrdiv">
										...
										<tbody>
											<c:forEach var="a" items="${alist}">
												<tr>
													...
													<td><center>
															<c:if test="${a.lyflag eq '待付款'}">
																<center>
																	<a class="layui-btn layui-btn-xs data-count-edit"
																		href="javascript:hpbt('${a.id}','fk');">付款</a>
																</center>
																<center>
																	<a class="layui-btn layui-btn-xs data-count-edit"
																		href="javascript:hpbt('${a.id}','tp');">退票</a>
																</center>
															...
															<c:if test="${a.lyflag eq '已付款'}">
																<center>
																	<a class="layui-btn layui-btn-xs data-count-edit"
																		href="javascript:hpbt('${a.id}','lp');">领票</a>
																</center>
																<center>
																	<a class="layui-btn layui-btn-xs data-count-edit"
																		href="javascript:hpbt('${a.id}','gq');">改签</a>
																</center>
																<center>
																	<a class="layui-btn layui-btn-xs data-count-edit"
																		href="javascript:hpbt('${a.id}','tp');">退票</a>
																</center>
																<%-- <input type="button" value="领票"
    								...
    								<c:forEach var="a" items="${alist}">
    									<tr>
    										...
    										<td>
    											<c:if test="${a.lyflag eq '待付款'}">
    												<input type="button" value="付款" onclick="hpbt('${a.id}','fk');" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='';"/>
    												<input type="button" value="退票" onclick="hpbt('${a.id}','tp');" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='';"/>
    											</c:if>
    											<c:if test="${a.lyflag eq '已付款'}">
	    											<input type="button" value="领票" onclick="hpbt('${a.id}','lp');" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='';"/>
	    											<input type="button" value="改签" onclick="hpbt('${a.id}','gq');" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='';"/>
	    											<input type="button" value="退票" onclick="hpbt('${a.id}','tp');" onmouseover="this.style.backgroundColor='red';" onmouseout="this.style.backgroundColor='';"/>
    											</c:if>
    											<c:if test="${a.lyflag eq '已领票'}">
    											</c:if>
