							...
							<td align="center" valign="top">
								<div id="nrdiv">
										...
										<thead>
											<tr>
												...
												<th><center>身份证号</center></th>
												<th ><center>密码</center></th>
												<th><center>注册时间</center></th>
										...
										<tbody>
											<c:forEach var="a" items="${alist}">
												<tr>
													...
													href="javascript:updbt('${a.id }','${a.cidcard }','${a.cpassword }','${a.cname }');">修改</a>
														</center></td>
													<td><center>
										...
										<c:forEach var="a" items="${alist}">
											<tr>
												...
												<td><a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete"
													href="javascript:updbt('${a.id }','${a.cidcard }','${a.cpassword }','${a.cname }');">修改</a></td>
								...
								<div id="gldiv" style="display: none;">
									<table>
										...
										<tr>
											<td>姓名：</td>
											<td><input type="text" id="gcname" name="gcname"
												value="" /></td>
										</tr>
										<tr>
										...
										<tr>
											<td>身份证号：</td>
											<td><input type="text" id="gcidcard" name="gcidcard"
												value="" /></td>
										</tr>
										<tr>
											<td height="15" colspan="2"></td>
										...
										<tr>
											<td>登录密码：</td>
											<td><input type="text" id="gcpassword" name="gcpassword"
												value="" /></td>
										</tr>
										<tr>
											<td height="15" colspan="2"></td>
										...
										<tr>
											...
											<a
												...
												class="layui-btn" onclick="rst();">取消 </a>
											<!-- <input
