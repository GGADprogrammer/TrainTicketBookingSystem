						...
						<tr>
							<td align="center">
								<form class="layui-form layui-form-pane" action="">
									...
									<tr>
										<td>站点名称：</td>
										<td><input type="text" id="ckzdname" name="ckzdname" /></td>
							...
							<td align="center" valign="top">
										...
										<tbody>
											<c:forEach  var="a" items="${alist}">
												<tr>
													...
													href="javascript:updbt('${a.id }','${a.zdname }');">修改</a>
														</center></td>
													<td><center>
															<a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete"href="javascript:delbt('${a.id }');">删除</a>
														</center></td>
												</tr>
											</c:forEach>
										...
										<c:forEach var="a" items="${alist}">
											<tr>
												...
												<td><a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete"
													href="javascript:updbt('${a.id }','${a.zdname }');">修改</a></td>
								...
								<div id="gldiv" style="display: none;">
									<table>
										...
										<tr>
											<td>站点名称：</td>
											<td><input type="text" id="gzdname" name="gzdname"
												value="" /></td>
										</tr>
										<tr>
